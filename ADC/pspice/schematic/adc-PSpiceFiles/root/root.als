...
X_CNTA          CNTA(CLK=CLK RESET=RST_CNT EN=N137773 Q1=Q0 Q2=Q1 Q3=Q2 Q4=Q3 VDD=VCC VSS=0 ) CN
...
X_IC10          IC10(A=S0 B=S1 C=S2 D=0 0=NX0 1=NX1 2=N99368 3=M_UN0004 4=NX4 5=M_UN0005 6=M_UN0006 7=M_UN0007 8=M_UN0008
+9=M_UN0009 ) CN @ADC.root(sch_1):INS84165@CD4028BEE4.CD4028BEE4.Normal(chips)
...
X_U81C          U81C(A=CLK Y=N141043 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS140957@74HC.74HC04.Normal(chips)
U_DSTM7          DSTM7(VCC=$G_DPWR GND=$G_DGND OUT=N142316 ) CN @ADC.root(sch_1):INS142296@SOURCSTM.DigStim1.Normal(chips)
X_OUTPUTBUFF1          OUTPUTBUFF1(CLOCK=WR RESET=N142316 DATA_INPUT_DISABLE_G1=0 DATA_INPUT_DISABLE_G2=0 Q1=Q0 Q2=Q1 Q3=Q2 Q4=Q3
+OUTPUT_DISABLE_M=VCC OUTPUT_DISABLE_N=VCC DATA_1=O0 DATA_2=O1 DATA_3=O2 DATA_4=O3 ) CN
+@ADC.root(sch_1):INS142348@CD4076BM.CD4076BM.Normal(chips)
U_DSTM8          DSTM8(VCC=$G_DPWR GND=$G_DGND OUT=N143050 ) CN @ADC.root(sch_1):INS143030@SOURCSTM.DigStim1.Normal(chips)
X_OUTPUTBUFF2          OUTPUTBUFF2(CLOCK=WR RESET=N143050 DATA_INPUT_DISABLE_G1=0 DATA_INPUT_DISABLE_G2=0 Q1=Q4 Q2=Q5 Q3=Q6 Q4=Q7
+OUTPUT_DISABLE_M=VCC OUTPUT_DISABLE_N=VCC DATA_1=O4 DATA_2=O5 DATA_3=O6 DATA_4=O7 ) CN
...
X_U83           U83(J=N140538 CLK=N141043 K=N159974 Q=N137773 Qbar=M_UN0010 VCC=$G_DPWR GND=$G_DGND ) CN
+@ADC.root(sch_1):INS159653@DIG_PRIM.JKFF.Normal(chips)
X_U84C          U84C(A=N140538 Y=N159974 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS159892@74HC.74HC04.Normal(chips)
X_U29A          U29A(A=N162386 B=N162460 Y=N162372 VCC=$G_DPWR GND=$G_DGND ) CN
+@ADC.root(sch_1):INS162390@74LS.74LS08.Normal(chips)
X_U10B          U10B(A=S0 B=S1 Y=I1 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS162774@74LS.74LS08.Normal(chips)
X_U34B          U34B(A=P B=RST_IN Y=N162680 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS162624@74LS.74LS32.Normal(chips)
...
X_U30B          U30B(A=S1 B=N162588 Y=N162520 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS162482@74LS.74LS32.Normal(chips)
X_U6B           U6B(A=S0 B=S1 Y=N162266 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS162190@74LS.74LS32.Normal(chips)
X_U31A          U31A(A=S0 B=S2 Y=N162588 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS162560@74LS.74LS08.Normal(chips)
X_U35A          U35A(A=N162520 B=N162680 Y=MEAS VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS162528@74LS.74LS08.Normal(chips)
...
X_U9B           U9B(A=S1 Y=N162386 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS162332@74HC.74HC04.Normal(chips)
X_U9E           U9E(A=S1 Y=RST_IN VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS162708@74HC.74HC04.Normal(chips)
X_U7A           U7A(A=N162266 Y=WR VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS162218@74HC.74HC04.Normal(chips)
X_U85A          U85A(+IN=N164985 -IN=N01917 V+=VCC V-=0 OUT=N154077 ) CN @ADC.root(sch_1):INS164094@OPAMP.MC1458.Normal(chips)
X_U85B          U85B(+IN=0 -IN=N01900 V+=VCC V-=VSS OUT=N01917 ) CN @ADC.root(sch_1):INS164419@OPAMP.MC1458.Normal(chips)
R_R3            R3(1=N164985 2=N154077 ) CN @ADC.root(sch_1):INS164862@ANALOG.R.Normal(chips)
R_R4            R4(1=N164994 2=N164985 ) CN @ADC.root(sch_1):INS164969@ANALOG.R.Normal(chips)
V_V6            V6(+=N164994 -=0 ) CN @ADC.root(sch_1):INS165758@SOURCE.VDC.Normal(chips)
X_U86A          U86A(+IN=N154077 -IN=0 V+=VCC V-=0 OUT=P ) CN @ADC.root(sch_1):INS171463@OPAMP.MC1458.Normal(chips)
_    _(A=A)
_    _(A=A)
_    _(CLK=CLK)
_    _(CLK=CLK)
