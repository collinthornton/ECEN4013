...
X_U129          U129(J=N312053 CLK=CLK K=S0CHANGE Q=Q7RISE Qbar=M_UN0012 VCC=$G_DPWR GND=$G_DGND ) CN
+@ADC.root(sch_1):INS311929@DIG_PRIM.JKFF.Normal(chips)
X_U131A          U131A(A=N251743 B=N3120311 Y=N312053 VCC=$G_DPWR GND=$G_DGND ) CN
+@ADC.root(sch_1):INS312015@74LS.74LS08.Normal(chips)
X_U132          U132(J=Q7 CLK=CLK K=N320539 Q=M_UN0013 Qbar=N320697 VCC=$G_DPWR GND=$G_DGND ) CN
+@ADC.root(sch_1):INS320312@DIG_PRIM.JKFF.Normal(chips)
X_U133A          U133A(A=Q7 Y=N320539 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS320478@74HC.74HC04.Normal(chips)
X_U134A          U134A(A=N320697 B=Q7 Y=N3120311 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS320610@74LS.74LS08.Normal(chips)
_    _(A=A)
_    _(A=A)
_    _(ARISE=ARISE)
_    _(CLK=CLK)
