...
X_CNTA          CNTA(CLK=N237358 RESET=RST_CNT EN=N160004 Q1=Q0 Q2=Q1 Q3=Q2 Q4=Q3 VDD=VCC VSS=0 ) CN
...
X_IC10          IC10(A=S0 B=S1 C=S2 D=0 0=SB0 1=SB1 2=SB2 3=M_UN0005 4=SB4 5=M_UN0006 6=M_UN0007 7=M_UN0008 8=M_UN0009 9=M_UN0010
+) CN @ADC.root(sch_1):INS84165@CD4028BEE4.CD4028BEE4.Normal(chips)
X_U49C          U49C(A=SB0 Y=NZ0 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS85710@74HC.74HC04.Normal(chips)
X_U48C          U48C(A=SB0 Y=NY0 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS85799@74HC.74HC04.Normal(chips)
X_U50C          U50C(A=SB1 Y=NY1 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS86252@74HC.74HC04.Normal(chips)
...
X_U62C          U62C(A=SB2 Y=NZ2 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS99307@74HC.74HC04.Normal(chips)
...
X_U67C          U67C(A=SB4 Y=NY4 VCC=$G_DPWR GND=$G_DGND ) CN @ADC.root(sch_1):INS101026@74HC.74HC04.Normal(chips)
V_V5            V5(+=VSS -=0 ) CN @ADC.root(sch_1):INS129301@SOURCE.VDC.Normal(chips)
X_U78A          U78A(A=MEAS B=CLK_EN_OVERIDE Y=N160004 VCC=$G_DPWR GND=$G_DGND ) CN
...
X_U105          U105(J=N254178 CLK=CLK K=S0CHANGE Q=ARISE Qbar=M_UN0011 VCC=$G_DPWR GND=$G_DGND ) CN
...
X_U120          U120(J=VCC CLK=N326631 K=VCC Q=N271786 Qbar=M_UN0012 VCC=$G_DPWR GND=$G_DGND ) CN
+@ADC.root(sch_1):INS271495@DIG_PRIM.JKFF.Normal(chips)
X_U121B          U121B(A=N086260 G=N326631 VDD=VCC VSS=0 ) CN @ADC.root(sch_1):INS271582@ADC.CD40106B_0.Normal(chips)
