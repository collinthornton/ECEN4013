...
X_U88           U88(+=0 -=N01917 V+=VCC V-=0 OUT=P ) CN @ADC.root(sch_1):INS200250@TEX_INST.LM2903/5_1/TI.Normal(chips)
C_C4            C4(1=0 2=P ) CN @ADC.root(sch_1):INS201783@ANALOG.C.Normal(chips)
R_R3            R3(1=P 2=N201906 ) CN @ADC.root(sch_1):INS201808@ANALOG.R.Normal(chips)
V_V6            V6(+=N201906 -=0 ) CN @ADC.root(sch_1):INS201833@SOURCE.VDC.Normal(chips)
_    _(A=A)
_    _(A=A)
_    _(CLK=CLK)
_    _(CLK=CLK)
